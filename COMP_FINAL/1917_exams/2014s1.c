...
The value of z will be __________
...
The value of result will be __________
...
double everage(int array[], int size) {
    int i = 0;
    int sum = 0;
    while (i < size) {
        sum = sum + array[i];
...
10    string encodeTable = malloc(sizeof(string));
11    int i = 0;
12
...
19    }
20
21    /* now create the encoded message */
22    char cipherText[MAX_MESSAGE_LENGTH] = {0};
23    i=0;
