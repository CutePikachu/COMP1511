...
the address of this two are different
________
__________
...
void classify (int array[], int n) {
    ...
    if (zero_count == 0) {
        ...
        printf("b\n");
    } else if (non_count%2 == -1 || non_count%2 == 0) {
        printf("c\n");
    } else {
        printf("d\n");
    }
...
Complex multiply (Complex a, Complex b) {
    Complex com;
    com.re = a.re * b.re - a.im * b.im;
    com.im = a.im*b.re+ b.im*a.re;
    return com;
}
...
int main() {
    ...
    Complex mul = multiply(new, new);
    Complex com;
    com.re= 0.1;
    com.im = 0.9;
    Complex add = add(mul, com);
